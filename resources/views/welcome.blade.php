                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @auth
                            <li class="nav-item dropdown no-arrow">
                                <a class="btn btn-primary ml-lg-3 nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                        ...
                        @else
                            ...
                            <li class="nav-item">
                                <a class="btn btn-primary ml-lg-3" href="{{ route('register.index') }}">Register</a>
                            </li>
                        @endauth
                ...
                <div class="item">
                    <div class="card-doctor">
                        ...
                        <div class="body">
                            ...
                            @auth
                            <a href="" class="w-20 p-2">
                             
                              <button type="submit" class="btn btn-warning">Visit</button>
